...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap Footer pour affichage (Facebook,twiter etc..) CDN -->
...
<link href="https://fonts.googleapis.com/css2?family=Montagu+Slab:wght@100&display=swap" rel="stylesheet">

    <title>MonGit</title>

<style>
    body{
        font-family: 'Zilla Slab', sherif
    }
</style>
    ...
    -->
        ...
        <footer class="bg-dark text-white">
            ...
            <div class="d-flex align-items-end div-footer-copyright">
                <p class="text-center zone-copyright py-3 mb-0">&copy; 2021 | Rigobert DANON</p>
            </div>
        </footer>
...
<!-- Bootstrap Défilement d'mage CDN -->
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.1/dist/js/bootstrap.bundle.min.js" integrity="sha384-/bQdsTh/da6pkI1MST/rWKFNjaCP5gBSY4sEBT38Q/9RBh9AH40zEOg7Hlq2THRZ" crossorigin="anonymous"></script>
